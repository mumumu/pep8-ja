...
- しかし、標準ライブラリ以外では、PEP 484のルールの範囲内で実験することが今はお勧めです。たとえば、PEP 484 の型アノテーションの書式を使った大規模なサードパーティのライブラリやアプリケーションを作り、これらのアノテーションを追加するのがどれだけ簡単だったかをレビューしたり、アノテーションがない場合にコードの理解度があがるかどうかを観察すること、などです。
